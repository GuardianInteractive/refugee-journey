...
JOURNEY.data = {
	...
	scene2: {
		...
		text: 'There is bad news. You can’t fly to Sweden because you don’t have a visa and there are now no new visas being granted to anyone in Syria. (CHECK) A very small number of family reunification visas are being granted to close family members such as children and spouses but this doesn’t apply to you. Last year in Europe only X family reunification visas were issued. (CHECK) Even if your husband was in Sweden or the UK you would not be gaurunteed a visa to join them.
			...
			If you want to leave Syria you have to travel overland. And if you hope to reach a northern European country you will have to do so illegally. There are now almost no legal routes to reach countries like Italy, Sweden or the UK, even though it is legal to claim asylum once you get there.

			It is not just Syrians who face this catch 22 situation. The increase of visas needed for people leaving conflict ridden countries has massively increased over the past decade.


			XXX AUDIO INSERT - (MOHAMED – case study, have audio – he had a visa from previous travels – flew into UK with his family)

			Mohamed travelled directly to the UK with his family using a visa he received before war broke out. When he reached Heathrow airport he claimed asylum at the immigration desk. '
		choice: {
...
VIDEO INSERT - Somali man now settled in Sweden. ??

You are not considered vulnerable enough, as the few places are being offered to families with sick or disabled children, or a parent who is struggling to cope with looking after children. The response so far has been criticised as ’shameful’ by Amnesty International and ’feeble’ by UNHCR. The country that has offered the most places is Germany, which has said it will take 10,000 people directly from camps.

You are in good health as are your children so you now have two choices.',
        asset: 'start',
        choice: {
            text: '1 – You decide to stay in Turkey, it’s not perfect but it’s safe and a better option than living under mortar attack in Syria or taking a dangerous journey overland into Europe. (GO TO SCENE 5)

2 – You decide you will take the overland route through Greece, the nearest country and the most common illegal entry point into the EU. (GO TO SCENE 6)',
            options: [
...
scene51: {
        ...
        text: 'You can’t work, but you are not under attack so you have a sense of safety. The camp you are in is not a bad one and the Turkish government is doing what it can to provide an education for your children and they are able to go to school for a few hours a day.

It is estimated that by the end of 2014 there could be a million Syrians living in Turkey. The UNHCR and other aid organisations have warned of the pressure this is putting on Turkey and also on neighbouring Jordan and Lebanon.

You start to feel at home in the camp eventually. You meet your neighbours. One of them has a Palestinian grandfather who knows people from his childhood who went to a refugee camp in Lebanon in 1948 and are still there. You wonder if your children will spend their entire lives in this camp. Your story is not over, but nor is it continuing
You stay in Turkey and hope that the peace talks succeed and you can return to Syria soon.',
        asset: 'start',
        success:false,
        end: true}
    },
...
scene6: {
        ...
        text: 'You decide that however dangerous the journey across the Greek border might be might be, it’s better than staying in a camp indefinitely. If you make it to northern Europe you are pretty much guarunteed a life in which you can work and move on with your life until it is safe to return to Syria. You leave the camp and take your children to Istanbul, which is full of migrants from across the Middle East and Asia, as well as people smugglers who offer, for a price, to take you across the Greek border.

Unfortunately you do not make it across the Greek border. For the past decade this has been the main route for migrants crossing irregularly into the European Union. Over 90 per cent of migrants entered the EU in this way in 2012.

But since 2010 there has been a huge increase on EU support for border protection in the Evros region where most migrants cross. (stat here about numbers dropping). In 2012, 8,000 Syrians were arrested on the Greek border. You are stopped by border guards who are abusive to you and your children They take you back in Turkey without assessing whether you are in need of refugee protection even though this is a breach of international law.

XXXX VIDEO INSERT (John D has interview with woman who was detained on the Greek border with her daughter, in a van for 11 hours with no water then dumped back into Turkey)

A recent report detailed evidence of an illegal ’push back’ policy on both the land and sea border between Turkey and Greece. (LINK TO REPORT http://ecre.org/component/content/article/70-weekly-bulletin-articles/486-pro-asyl-accuses-greece-of-systematically-pushing-back-refugees-at-the-greek-turkish-border.html)

You make your way back to Istanbul to begin again. You now have two choices.',
        asset: 'start',
        choice: {
 ...
 scene7: {
        title: 'Into Greece',
        text: 'This time, after paying the smugglers again, you are one of the gradually reducing number who do make it over the Evros border and into Greece. (do we have a story to illustrate this???) After crossing the border you travel to Athens (how?). Friends in the Syrian community in Istanbul have given you the contact details of a church that helps refugee families so you head there.

        	Now you are here you have two choices.',
        asset: 'start',
        choice: {
            text: 'You know that the borders to leave Greece are watched to stop irregular migrants leaving as well as entering, so you could claim asylum here rather than put your children through more difficult travelling.

				Or you could keep going to Sweden, which means avoiding detection by Greek border guards. Migrants without refugee status in Greece are frequently rounded up and detained.',
            options: [
